...
```{r}
verma = fm_construct(monetary = eusilc$red_eq, weight = eusilc$DB090, ID = NULL,
                     HCR = 0.12, interval = c(1,10), alpha = NULL, fm = "TFR")
```
...
```{r}
fm_construct(monetary = eusilc$red_eq, weight = eusilc$DB090, ID = NULL, HCR = 0.12, interval = c(1,20), alpha = NULL, fm = "verma2")
```
