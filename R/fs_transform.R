...
#'
#' @details
#' The function calculates deprivation score for item j and individual i as d_{j,i} = (1-F(c_{j,i})) / (1-F(1)) where F(c_{j,i}) is the value of j-th item cumulation function for the i individual.
